...
#word = [] 		# stores the word to decode/encode
#data = ["1"] 		# binary data goes here
helpMsg = """Usage:
...
def varSetup(): #key):
    ...
    a, b, c= 15, 1, 2 		# a = necklace length, b = starting point, c = increase for each necklace check
                                        # a should be > 11 and < 5000, b must be odd and far enough below 2^(a-1) to ensure enough necklaces are generated
                                        # c is a multiple, searches every c values starting at b. even values save time, higher values reduce possible necklaces
...
a, b, c, d, casSeed = varSetup() # make sure key is used
